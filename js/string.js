...
console.log(text.lenght); // ile znaków
var pierwszy = text.charAt(0); // pobieranie znaków o określonym indexie
...
console.log(text.charCodeAt(0)); //pobiera koda ascii znaku
